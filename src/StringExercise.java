...
//        System.out.println(education.replace("education", "though control" ));
        ...
        System.out.println(education.replace("We don't need no education", "Check \"this\" out!, \"s inside of \"s!"));
        String check = "Check \"this\" out!, \"s inside of \"s!";
        System.out.println(check);

        //In windows, the main drive is usually C:\
        System.out.println(education.replace("We don't need no education", "In windows the main drive is usually C:\\"));
        String windows = "In windows the main drive is usually C:\\";
        System.out.println(windows);

        //I can do backslashes \, double backslashes \\,
        //and the amazing triple backslash \\\!
        System.out.println(education.replace("We don't need no education", "I can do backslashes \\, double backslashes \\\\, and the amazing triple backslashes \\\\\\!"));
